          ...
          <div className="navbar-profile" onClick={toggleDropdown}>
            ...
            {dropdownVisible && (
              <ul className="nav-profile-dropdown">
                <li><img src={assets.bag_icon} alt="Orders" className="navbar-icon" /><p>Orders</p></li>
                <hr />
                <li onClick={logout}><img src={assets.logout_icon} alt="Logout" className="navbar-icon" /><p>Logout</p></li>
              </ul>
            )}
          </div>
        )}
